...
SetupTaxiDrivers = function(data) {
    ...
    $.each(data, function(job, jobData) {
        $(".taxis-list").append(`<h1 style="font-size:1.64vh; padding:1.02vh; color:#fff; margin-top:0; width:100%; display:block; background-color: #5f2c2c;">Available Drivers</h1>`);
